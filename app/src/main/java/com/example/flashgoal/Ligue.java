...
public class Ligue extends AppCompatActivity implements Adapter.OnItemClickListener{
    ...
    List<Club> clubs;
    private static String JSON_URL = "http://10.0.2.2:3000/clubsL1";
    Adapter adapter;
    ...
    private void extractClubs(){
        ...
        final JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, JSON_URL, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                adapter.setOnItemClickListener(Ligue.this);
